...
class EmpiricalALPLearningComputer():
    ...
    def compute_alp(self, task, reward):  # TODO change this function
        ...
        if len(self.alp_knn) > 5:
            ...
            dist, idx = self.alp_knn.nn_y(task)  # TODO applying soft argmin

            # 2 - Retrieve corresponding reward  # TODO implement the formula
...
class ALPLearningGMM():
    def __init__(self, mins, maxs, seed=None, params=dict()):
        ...
        # Init ALP computer
        self.alp_computer = EmpiricalALPLearningComputer(len(mins), max_size=alp_max_size, buffer_size=alp_buffer_size)
